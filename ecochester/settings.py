"""
Django settings for ecochester project.
...
SECRET_KEY = 'wm#3o4u3a5@=we(y^@g_9ithv&*%r(il1o@g4fg_u-p#+znva*'
...
WSGI_APPLICATION = 'ecochester.wsgi.application'
